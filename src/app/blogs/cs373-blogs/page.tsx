...
export default function CS373Blogs() {
  ...
  const finalWeekAnswers = [
    <ul>
      ...
      <li>
        collaboration is essential to the quality of your code and to your well-being in producing
        it
      </li>
    ...
    <>
      ...
      something on the spot or didn't know the answer, Professor Downing would help guide them
    ...
    <>
      ...
      except one, and that would in turn bring the entire grade down. Professor Downing said he has
      a solution for that, but when he described it, it seemed pretty vague.
    </>,
    <>
      Although I didn't use it much this semester, I did frequently use it last semester. Help
      Sessions were also quite helpful, as TAs could be there in-person to basically help anyone
      with anything. I personally never had a problem with this but Help Sessions can definitely be
      not as helpful when there are a high amount of people going.
    </>,
    <>
    ...
    <>
      In general, the principles I've learned from these papers were pretty familiar but
      understanding them at a deeper level was nonetheless fascinating.
    </>,
    <>
      Regarding the papers that discussed getters and setters, they were intriguing as well. I've
      been previously taught to avoid getters and setters but I'm glad to have gone far more
      in-depth on the reason “Why?” through these papers, learning specifically about how getters
      and setters can be extremely detrimental to object-oriented programming.
    </>,
    <>
    ...
    <>
      ...
      code between our team and see what each other are doing for an effective experience. Other
      than that, simple communication through Discord is always helpful.
    </>,
    <>
      This was definitely the least exciting and fun part of the entire class structure. If there's
      anything I felt overwhelmed with and disliked, it would be learning all of these massive
      systems by ourselves. We clearly worked through it in the end, but it was mind-bogging at
    ...
    <>
      ...
      of my other classes. The aspect of Python programming and web dev seems especially important
      in computer science and my future career path. I am unquestionably satisfied with the
      knowledge that I exited the class with.
    </>,
  ];
  ...
  return (
    <div className={styles.main}>
      ...
      {finalWeekQuestions.map((question, index) => (
        <div key={index}>
          <strong>{question}</strong>
          <i>{finalWeekAnswers[index]}</i>
        </div>
      ))}
    </div>
  );
