...
export const ANSWERS = [
  <>
    Hi, I am Forrest Sun! I'm a junior that grew up in Spring, Texas, part of the Greater Houston
    Area. For reference, it's about 30 minutes away from downtown Houston.
  </>,
  <>
  ...
  <>
    Taking a software engineering class seems like a fantastic way to get a better understanding of
    what my future career may need me to do. On top of that, taking object-oriented programming with
    Professor Downing last semester was an absolute blast so I can't wait to do it again.
  </>,
  <>
    I expect to learn a lot about web development and what software engineering truly entails. I am
    hoping that after this class, my knowledge of Python, Javascript, and SQL will be far better so
    I am able to utilize it in the field.
  </>,
  <>
    I do not know much about Javascript or web programming, but I have been meaning to learn about
    these as they seem very related to my future career options. As for Python and SQL, I have some,
    albeit very limited, experience in these two languages. Similar to JS and web programming, I
    believe these are vital to succeeding in any front-end development job.
  </>,
  <>
  ...
  <>
    ...
    understand the thought process behind the grading style — basically, you have to be proficient
    in everything in order to be proficient in the class. The thing is (depending on how hard the
  ...
  <>
    Searching for one more internship to squeeze in before graduating? You might have seen the
    Summer 2023 megathread for software engineering internships, but did you know there is also a
    Fall 2023 internships megathread as well? If you're interested in finding a co-op, this is
    definitely the place to begin searching. It's pretty empty for now as many Fall internships and
    co-ops are not open yet, but keep an eye on it as they open up.
    <Link
      href="https://github.com/bsovs/Fall2023-Internships"
